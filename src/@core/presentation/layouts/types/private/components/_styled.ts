...
import { AppIcon, AppText } from "@/@core/presentation/shared"
...
export const MenuDesktopContainer = styled.div`
  ...
  ${containerGeral}
`
export const MenuMobileContainer = styled.div<{ status: boolean }>`
  background: #fff;
  z-index: 2;
  position: fixed;
  top: 4rem;
...
export const MenuFooterItemIcon = styled(AppIcon)`
  ...
  font-size: 1rem;
`
export const LayoutContainer = styled.div<{ status: boolean }>`
