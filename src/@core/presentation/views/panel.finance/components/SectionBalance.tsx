...
import { AppColumn, AppColumns, AppText } from '@/@core/presentation/shared'
import { PagePanelFinanceStore } from '@/store/hook'
import styled from '@emotion/styled'
import { containerResponsivePadding } from '@/@core/presentation/layouts/types/private/components/_styled'
